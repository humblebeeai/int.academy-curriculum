...
![Monitors and a laptop](../../../assets/images/software_eng.png)
...
Alternatively, complete the full [Systems & Networking module](/docs/2026-07-09/softlanding/core-systems/networking) for deeper understanding.
...
/>
**Goal**: Build a mobile app consuming your API. **Key Topics**: Widgets, State Management,
API Integration.
...
/>
**Goal**: Build a responsive web app consuming your API. **Key Topics**: Components,
Hooks/Composition API, Routing.

Note: For deeper integration and deployment practices, see the [Infra Basics module](/docs/2026-07-09/softlanding/core-systems/infra-basics).
