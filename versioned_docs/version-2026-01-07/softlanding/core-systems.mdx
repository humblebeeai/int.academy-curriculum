...
[Explore Module →](./core-systems/01-math-ml.mdx)
</div>

<div className="track-card" style={{ border: '1px solid var(--ifm-color-emphasis-200)', borderRadius: '12px', padding: '1.5rem', backgroundColor: 'var(--ifm-background-surface-color)' }}>

### 2. Advanced AI & Coding
...
[Explore Module →](./core-systems/02-advanced-ai.mdx)
</div>
...
[Explore Module →](./core-systems/03-networking.mdx)
</div>
...
[Explore Module →](./core-systems/04-fullstack-ops.mdx)
</div>
...
- Be ready to start a **Phase 3 specialization track** and a production-grade capstone
