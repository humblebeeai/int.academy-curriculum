...
import problemCardStyles from './assets/ProblemCard.module.css';
...
[Start School Program →](/docs/2026-01-07/school/intro)
...
[Start Soft Landing →](/docs/2026-01-07/softlanding/intro)
...
[Explore Specializations →](/docs/2026-01-07/softlanding/specializations/overview)
...
<div className="mdx-cta-buttons">
  <a href="/docs/2026-01-07/school/intro" className="button button--primary button--lg mdx-cta-button">
    <Sparkles size={18} className="mdx-cta-button-icon" />
    <span>Start Phase 1 (Beginner)</span>
  </a>
  
  <a href="/docs/2026-01-07/softlanding/intro" className="button button--primary button--lg mdx-cta-button">
