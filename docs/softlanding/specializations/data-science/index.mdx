...
<ResourceCard
  type="article"
  title="Dimensionality Reduction in Machine Learning"
  url="https://anilpise7.medium.com/dimensionality-reduction-in-machine-learning-simplifying-complex-data-for-better-insights-a2181c2b519b"
  duration="15-20 minutes"
  difficulty="beginner"
  why="Practical introduction to PCA and t-SNE with Python examples, showing how to reduce high-dimensional data for better model performance and visualization."
/>
