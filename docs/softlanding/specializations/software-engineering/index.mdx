...
# <Code2 /> AI Software Engineering Track
...
Alternatively, complete the full [Systems & Networking module](docs/softlanding/core-systems/03-networking.mdx) for deeper understanding.
...
<ResourceCard
  type="video"
  title="TCP/IP vs OSI Models"
  url="https://youtu.be/CRdL1PcherM"
  duration="30-45 minutes"
  difficulty="beginner"
  why="Gives you the layer-by-layer framework you’ll use every time you debug a network issue in production."
/>
...
<ResourceCard
  type="video"
  title="Real-World TCP/IP"
  url="https://youtu.be/3kfO61Mensg"
  duration="30-45 minutes"
  difficulty="intermediate"
  why="Connects theory to real packets and traffic patterns so TCP handshakes and UDP trade-offs make sense."
/>
...
/>
**Goal**: Build a mobile app consuming your API. **Key Topics**: Widgets, State
...
/>
**Goal**: Build a responsive web app consuming your API. **Key Topics**:
Components, Hooks/Composition API, Routing.

Note: For deeper integration and deployment practices, see the [Full-Stack Operations module](docs/softlanding/core-systems/04-fullstack-ops.mdx).
...
[View Detailed Capstone Requirements →](/docs/softlanding/specializations/software-engineering/capstone)
