...
Note: For deeper integration and deployment practices, see the [Infra Basics module](docs/softlanding/core-systems/04-infra-basics.mdx).
...
<div style={{ marginTop: "8px", marginBottom: "8px" }}>
  <Link
    ...
    to="/docs/softlanding/specializations/software-engineering/capstone"
  >
    Start AI Software Engineering Capstone
  </Link>
</div>
