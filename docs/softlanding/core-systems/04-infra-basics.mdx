...
<ResourceCard
  ...
  url="https://www.youtube.com/watch?v=pBASqUbZgkY&t"
  difficulty="intermediate"
  description="Additional practical material on serving AI workloads with FastAPI."
 />
...
<ResourceCard
  ...
  difficulty="intermediate"
  description="Additional FastAPI material for building and exposing AI services."
 />
