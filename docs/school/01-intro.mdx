...
<div>
**<Brain size={16} style={{ verticalAlign: 'text-bottom', marginRight: '0.35rem' }} /> Computational Thinking**  
**Time:** 15-20 hours  
...
<div>
**<Calculator size={16} style={{ verticalAlign: 'text-bottom', marginRight: '0.35rem' }} /> Mathematics for AI**  
**Time:** 160-180 hours  
Calculus, linear algebra – the language of AI.  
*You'll understand WHY models work, not just HOW to use them.*
</div>

<div>
**<BarChart3 size={16} style={{ verticalAlign: 'text-bottom', marginRight: '0.35rem' }} /> Probability & Statistics**  
**Time:** 60-90 hours  
...
<div>
**<Database size={16} style={{ verticalAlign: 'text-bottom', marginRight: '0.35rem' }} /> Python Data Engineering**  
**Time:** 10-14 hours  
Pandas, data cleaning, and Git version control.  
*You'll wrangle messy real-world data like a pro.*
</div>

<div>
**<Cpu size={16} style={{ verticalAlign: 'text-bottom', marginRight: '0.35rem' }} /> IoT & Activation**  
**Time:** 4-7 hours  
