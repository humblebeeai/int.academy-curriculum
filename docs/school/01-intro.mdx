...
<div className="mdx-checklist">
  ...
  <label className="mdx-checklist-item">
    <input type="checkbox" />
    <span>I am willing to struggle through confusion before breakthroughs happen.</span>
  </label>
  <label className="mdx-checklist-item">
    <input type="checkbox" />
    <span>I will seek help when stuck (Discord, documentation) rather than giving up.</span>
  </label>
  <label className="mdx-checklist-item">
    <input type="checkbox" />
