...
| Programming | Python Fundamentals  | Python fundamentals curriculum         | [HackerRank Python (Basic) Certification 🔗](https://www.hackerrank.com/skills-directory/python_basic) |
