...
| Programming | Python Fundamentals  | Python fundamentals curriculum         | [HackerRank Python (Basic) Certification <ExternalLink size={12} />](https://www.hackerrank.com/skills-directory/python_basic) |
...
<div>
  **
  <Database
    ...
    style={{ verticalAlign: "text-bottom", marginRight: "0.35rem" }}
  />{" "}
  Python Data Engineering** **Time:** 10-14 hours Pandas, data cleaning, and Git
  version control. *You'll wrangle messy real-world data like a pro.*
</div>
...
<div>
  **
  <Cpu
    ...
    style={{ verticalAlign: "text-bottom", marginRight: "0.35rem" }}
  />{" "}
  IoT & Activation** **Time:** 4-7 hours Deploy simple ML models to real devices
