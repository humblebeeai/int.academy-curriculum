...
<div className="mdx-checklist">
  <label className="mdx-checklist-item">
    <input type="checkbox" />
    <span>
      Completed core <strong>Statistics</strong> and{" "}
      <strong>Probability</strong> units in
      <strong> Statistics and Probability - Khan Academy</strong>
      (distributions, randomness, inference, random variables, conditional
      probability, Bayes’ rule), with a single{" "}
