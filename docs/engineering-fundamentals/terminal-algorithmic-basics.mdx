...
<ResourceCard
  type="course"
  title="Quick Start with Linux - LabEx"
  url="https://labex.io/courses/quick-start-with-linux"
  duration="3-4 hours"
  difficulty="beginner"
  why="Hands-on interactive lab walkthrough of core commands you'll use daily on servers: navigation, file ops, and permissions."
/>
